...
public class WordsProvider extends Provider<String[]> {

    private WordsProvider(Class<String[]> clazz) {
        super(clazz);
    }
    ...
    public String[] provide() {
        if (mLoadedData == null) {
            mLoadedData = new String[]{
                    ...
                    "aenean fermentum donec ut mauris eget massa tempor convallis nulla neque libero convallis eget eleifend luctus ultricies eu nibh quisque id justo sit amet sapien dignissim vestibulum vestibulum ante ipsum primis in",
                    ...
                    "quis libero nullam sit amet turpis elementum ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi quis",
                    ...
                    "vivamus vestibulum sagittis sapien cum sociis natoque penatibus et magnis",
                    "nisl duis bibendum felis sed interdum venenatis turpis enim blandit mi in porttitor pede justo eu massa donec dapibus duis at velit eu est congue elementum in hac habitasse platea dictumst morbi vestibulum velit id pretium iaculis diam erat fermentum justo",
